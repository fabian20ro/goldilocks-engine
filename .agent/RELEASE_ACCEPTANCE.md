...
## M7D exact-SHA deployment receipt

Round 116's accepted M7D candidate was subsequently deployed by the
release-owner workflow. This is a durable deployment receipt for the save
stability candidate, not a commercial-release completion claim:

| Receipt                  | Evidence                                                                                                                          |
| ------------------------ | --------------------------------------------------------------------------------------------------------------------------------- |
| Accepted candidate       | `caa334945f5b0a89bc1452609e9b118ba042df01`                                                                                        |
| Independent verification | Round 116 `.agent/verification/round-116.md`; verifier commit `2012dcddf6a25fc781fbd7efe0b6b133f148ad2b`                          |
| Hosted Verify            | [run 32582068882](https://github.com/fabian20ro/goldilocks-engine/actions/runs/32582068882), exact candidate head, success        |
| Pages deployment         | [run 32582472823](https://github.com/fabian20ro/goldilocks-engine/actions/runs/32582472823), `main` exact candidate head, success |
| Remote `main`            | `caa334945f5b0a89bc1452609e9b118ba042df01`                                                                                        |
| Live target              | [GitHub Pages site](https://fabian20ro.github.io/goldilocks-engine/)                                                              |
| Live identity            | HTTP 200; `build-info.json` version `45330c2e3a0014a55b93`, scope `/goldilocks-engine/`, cache name and service-worker ID match   |
| Live smoke               | 320×693 portrait; no document overflow; Jobs navigation/action reachable; zero console errors/warnings                            |
| Machine-readable receipt | `.agent/release-receipts/round-116.md`                                                                                            |

M7B WebKit/native/physical-performance evidence remains parked and
infrastructure-blocked under D-043/D-044. This receipt does not relabel that
gate, and subsequent documentation/tooling commits are not themselves a new
deployed candidate until independently verified and deployed at their exact
SHA.
...
| Save stability             | Golden fixtures for supported schema/content history; sealed-only malformed/stale/unsealed recovery; reload/offline; update across old saves; explicit supported-version policy; no duplicate commands or deductions        | Round 116 PASS and exact-SHA deployment receipt recorded; M7D product evidence is closed for the accepted candidate, while M7B commercial evidence remains open |
...
| Deployment and operations  | Fresh Verifier report names exact candidate SHA; hosted aggregate passes; Pages deploys that SHA; live `build-info.json` matches; clean branch and post-deploy smoke                                                        | M7D receipt recorded at `.agent/release-receipts/round-116.md`; later candidates still require their own exact-SHA receipt                                      |
